...
window.addEventListener('load', function () {
    ...
    // ~ CREATE WATER ~ //
    // water geometry
    let waterGeometry = new THREE.PlaneGeometry(14,6,256,256);
    ...
    button.addEventListener("click", function () {
        ...
        fetch("https://corsproxy.io/?https://itsthisforthat.com/api.php?json")
            ...
            .then(data => {
                ...
                // fade in text
                // referenced from https://www.reddit.com/r/learnjavascript/comments/winvtd/how_do_i_create_a_fade_in_affect_for_dynamically/
                displayedPitch.animate([{
                    opacity: 0
                  }, {
                    opacity: 1
                  }], {
    ...
    // ~ SCROLL PAGE ~ //
    // grab scroll icons
    let scrollPageDown = document.getElementById('scroll__page__down');
    let scrollPageUp = document.getElementById('scroll__page__up');

    // grab 'main' page
    let scrollMain = document.getElementById('main');

    // grab 'landing' page
    let scrollLanding = document.getElementById('landing');


    // when down icon is clicked, scroll to 'main' page
    scrollPageDown.addEventListener("click", function() {
        scrollMain.scrollIntoView({
            behavior: "smooth",
            block: "end"
        })
    ...
    scrollPageUp.addEventListener("click", function() {
        scrollLanding.scrollIntoView({
            behavior: "smooth",
            block: "start"
        })
